...
import imageNewPassword from "../../assets/NewPassword/images/vecteezy_3d-male-character-presenting-to-the-right_24132254.png";
import EyePassword from "../../assets/NewPassword/images/eye-crossed (1).png";
import '../../assets/Restpassword/style/SuccessRestpassword.css'
import imageRestsuccess from '../../assets/Restpassword/images/Group 1984081752.png'
      ...
      <div className="container-loginpage">
        <div className="Newpassword-div">
          <div className='toaster'>
            <img src={imageRestsuccess} className="succses-auth" alt="" />
          </div>
